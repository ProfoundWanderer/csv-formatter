...
def uploadcsv(request):
    ...
    try:
        ...
        # sep=None so pandas tries to get the delimiter and dtype=str so columns don't sometimes have .0 added and encoding to solve UnicodeDecodeError
        df = pd.read_csv(csv_file, sep=None, dtype=str, encoding='ISO-8859-1')
